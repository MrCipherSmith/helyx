...
ref: 647106e
mode: ingest
flow: 067 (explicit-flow-id)
created_at: 2026-09-17T09:15:40.316Z
context_mode: light
...
claims_applied: 9
claims_rejected: 0
verdicts_capped_to_unverifiable: 1
confirmed: 8
refuted: 0
unverifiable: 1
unverified: 0
...
|---|---|---|---|
| 2026-09-17-ingest-647106e-r03#F-007 | confirmed | unverifiable | reasoning alone produces no new evidence, so it records `unverifiable`. Run something, or check the class_scope sites. |
