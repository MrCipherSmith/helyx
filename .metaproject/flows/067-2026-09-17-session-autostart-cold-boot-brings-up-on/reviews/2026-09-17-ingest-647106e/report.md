...
[
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 decideRecordAfterStart in sessions/restore-plan.ts, covered by tests/unit/restore-plan.test.ts 'a cold start that brought nothing up clears the snapshot and does not claim the boot'"
    },
  ...
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 try/catch around the host_state upsert in recordLiveWindows, with the deploy-order reason recorded in the comment"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high",
    "class_scope": {
  ...
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 recordLiveWindows({ whenNoSession: 'empty' }) in the proj_stop branch"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 the daemon reads projects.name for the path, and --only matches name or path in cli.ts"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 decideRecordAfterStart returns recordBootId: false for --only, covered by tests/unit/restore-plan.test.ts"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      ...
      "evidence": "57f8c1f \u2014 documented in help(); the daemon never uses -s (the 2026-09-01 incident), and pane-level restore is a larger change than this follow-up"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 WITH prev AS (SELECT ... FOR UPDATE) in transitionSession and in both admin-daemon mass updates"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 snapshotLiveWindows returns { windows, stored } and tmuxStop warns when stored is false"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  },
  {
    ...
    "disposition": {
      "state": "acted-on",
      "evidence": "57f8c1f \u2014 the test deletes schema_versions for migration 56 and asserts runMigrations re-applies exactly it"
    },
    "reviewer": "claude-opus-5 (scripts/review.ts reviewer pipeline)",
    "confidence": "high"
  }
