...
created_at: 2026-09-17T09:14:52.725Z
context_mode: light
...
| finding | reason | why |
|---|---|---|
| <unnamed> | mutation | the claim carried id. A verifier can only delete: it cannot raise a severity, add a finding, or change a finding's text. |
| <unnamed> | mutation | the claim carried id. A verifier can only delete: it cannot raise a severity, add a finding, or change a finding's text. |
| <unnamed> | mutation | the claim carried id. A verifier can only delete: it cannot raise a severity, add a finding, or change a finding's text. |
| <unnamed> | mutation | the claim carried id. A verifier can only delete: it cannot raise a severity, add a finding, or change a finding's text. |
| <unnamed> | mutation | the claim carried id. A verifier can only delete: it cannot raise a severity, add a finding, or change a finding's text. |
