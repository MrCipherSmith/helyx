# Memory search: forum topic chat id pending next message swallow

Results: 2

### 1. Coverage programme: what is done, what is open, what is next  (score 1.683)
...
### 2. One rule in several files diverges, and review does not catch it  (score 1.618)
