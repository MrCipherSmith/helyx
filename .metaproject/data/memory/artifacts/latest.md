# Memory search: flow-012 questions Telegram ask-question waiter answer expiry stale hooks

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 1.589)
...
### 2. A comment that claims agreement is not a mechanism  (score 1.587)
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.587)
- type: known-mistake | status: accepted | confidence: high
- matched 1/11 terms; status accepted; confidence high
