# Memory search: flow-012 questions telegram M3 waitForAnswers recordAnswer

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 1.641)
...
### 2. A comment that claims agreement is not a mechanism  (score 1.639)
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.639)
- type: known-mistake | status: accepted | confidence: high
- matched 1/7 terms; status accepted; confidence high
