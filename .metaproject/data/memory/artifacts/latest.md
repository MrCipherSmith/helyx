# Memory search: turn summary stop hook forum topic response guard pending question pane parse tmux watchdog Telegram HTML message length

Results: 3

### 1. One rule in several files diverges, and review does not catch it  (score 1.716)
- type: known-mistake | status: accepted | confidence: high
- matched 4/18 terms; status accepted; confidence high
...
### 2. A comment that claims agreement is not a mechanism  (score 1.66)
- type: known-mistake | status: accepted | confidence: high
- matched 3/18 terms; status accepted; confidence high
...
### 3. Coverage programme: what is done, what is open, what is next  (score 1.552)
- type: task-note | status: accepted | confidence: high
- matched 1/18 terms; status accepted; confidence high
