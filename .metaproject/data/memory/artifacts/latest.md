# Memory search: supervisor broadcast compose project containers notification tmux

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 1.926)
- type: task-note | status: accepted | confidence: high
- matched 3/7 terms; status accepted; confidence high
...
### 2. A comment that claims agreement is not a mechanism  (score 1.638)
- type: known-mistake | status: accepted | confidence: high
- matched 1/7 terms; status accepted; confidence high
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.638)
- type: known-mistake | status: accepted | confidence: high
- matched 1/7 terms; status accepted; confidence high
