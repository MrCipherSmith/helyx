# Memory search: question request expiry ask telegram inline keyboard editMessage cancelRequest expireRequest

Results: 1

### 1. Coverage programme: what is done, what is open, what is next  (score 1.697)
- type: task-note | status: accepted | confidence: high
- matched 2/10 terms; status accepted; confidence high
