# Memory search: flow-017 expire questions persistence message ids rollback

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 1.622)
...
### 2. A comment that claims agreement is not a mechanism  (score 1.619)
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.619)
- type: known-mistake | status: accepted | confidence: high
- matched 1/8 terms; status accepted; confidence high
