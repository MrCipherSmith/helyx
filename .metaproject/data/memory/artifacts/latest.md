# Memory search: comment asserts more than code

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 2.496)
- type: task-note | status: accepted | confidence: high
- matched 5/5 terms; status accepted; confidence high
...
### 2. A comment that claims agreement is not a mechanism  (score 2.393)
- type: known-mistake | status: accepted | confidence: high
- matched 4/5 terms; status accepted; confidence high
...
### 3. One rule in several files diverges, and review does not catch it  (score 2.093)
- type: known-mistake | status: accepted | confidence: high
