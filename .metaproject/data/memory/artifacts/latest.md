# Memory search: status rendering StatusManager currentQuestion Telegram chat topic

Results: 2

### 1. Coverage programme: what is done, what is open, what is next  (score 1.639)
...
### 2. One rule in several files diverges, and review does not catch it  (score 1.637)
