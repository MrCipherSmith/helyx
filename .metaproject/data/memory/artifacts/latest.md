# Memory search: migration database sqlite test fixture

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 2.098)
...
### 2. A comment that claims agreement is not a mechanism  (score 1.696)
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.696)
- type: known-mistake | status: accepted | confidence: high
- matched 1/5 terms; status accepted; confidence high
