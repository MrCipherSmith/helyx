# Memory search: flow-012 questions telegram setupAskQuestionHook Claude settings hook cli

Results: 3

### 1. Coverage programme: what is done, what is open, what is next  (score 1.832)
- type: task-note | status: accepted | confidence: high
- matched 3/9 terms; status accepted; confidence high
...
### 2. A comment that claims agreement is not a mechanism  (score 1.607)
...
### 3. One rule in several files diverges, and review does not catch it  (score 1.607)
- type: known-mistake | status: accepted | confidence: high
- matched 1/9 terms; status accepted; confidence high
