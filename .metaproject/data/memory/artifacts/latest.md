# Memory search: supervisor status broadcast docker containers project stack

Results: 2

### 1. Coverage programme: what is done, what is open, what is next  (score 2.212)
- type: task-note | status: accepted | confidence: high
- matched 5/7 terms; status accepted; confidence high
...
### 2. One rule in several files diverges, and review does not catch it  (score 1.638)
