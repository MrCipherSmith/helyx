...
When Claude Code needs clarification before continuing a task, it can ask questions as native **Telegram polls** instead of plain text messages. You tap your answer, hit **Готово ✅**, and the results flow back automatically.
...
You:     tap Next.js, tap Yes, tap Готово ✅
...
Each question becomes one poll. All questions must be answered before **Готово ✅** is accepted — if you tap it early, the bot shows how many are left.
...
Poll sessions expire after **24 hours**. Clicking **Готово ✅** on an expired session shows a timeout message and marks the session as expired.
